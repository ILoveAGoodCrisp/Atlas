...
exports.runToolExecutable = void 0;
...
function findToolExecutable(startingDir, maxIterations) {
...
function getScenarioPath(documentPath) {
...
function createRelativeScenarioPath(toolPath, scenarioPath) {
...
exports.runToolExecutable = runToolExecutable;
